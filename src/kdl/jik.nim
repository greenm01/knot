...
proc toJVal(val: KdlVal): JsonNode =
  ...
  of KInt64:
    newJInt(val.i64)
  of KUInt8:
    newJInt(val.u8.BiggestInt)
  of KUInt16:
    newJInt(val.u16.BiggestInt)
  of KUInt32:
    newJInt(val.u32.BiggestInt)
  of KUInt64:
    newJInt(val.u64.BiggestInt)
  of KBigInt:
    newJString($val.bigint)  # JSON doesn't support arbitrary precision, store as string
  of KFloat32:
    newJFloat(val.f32.float64)
  of KFloat64:
    newJFloat(val.f64)
  of KDate:
    newJString(val.date)
  of KTime:
    newJString(val.time)
  of KDateTime:
    newJString(val.datetime)
  of KDuration:
    newJString(val.duration)
  of KEmpty:
    newJNull() # Treat KEmpty as null in JSON
